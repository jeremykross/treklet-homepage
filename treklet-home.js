...
function Ve(a) {
  return z(Ta) ? $.call(l, R.call(l, "1. Use it! To install in Chrome click <a href='", "http://174.143.169.193:8082", "treklet.user.js'> here</a>."), a) : z(Sa) ? $.call(l, "1. Use it! To install in Firefox get <a> Greasemonkey </a> and click here.", a) : z("\ufdd0'else") ? $.call(l, "1. Please use Chrome or Firefox to install in your browser.") : l
}
